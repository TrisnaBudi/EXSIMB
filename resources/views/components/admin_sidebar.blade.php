<aside class="col-12 col-sm-3 col-xl-2 px-sm-2 px-0 bg-dark d-flex sticky-top">
    <div class="d-flex flex-sm-column flex-row flex-grow-1 align-items-center align-items-sm-start px-3 pt-2 text-white">
        <a href="/dashboard" class="d-flex align-items-center pb-sm-3 mb-md-0 me-md-auto text-white text-decoration-none">
            <span class="fs-5">E<span class="d-none d-sm-inline">XSIMB</span></span>
        </a>
        <ul class="nav nav-pills flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto mb-0 justify-content-center align-items-center align-items-sm-start" id="menu">
            <li class="">
                <a class="nav-link px-sm-0 px-2" href="{{ route('admin.dashboard') }}">
            ...
            {{-- <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-dark text-small" aria-labelledby="dropdown">
                    <li>
