                ...
                <form id="edit-kerusakan" action="" method="post">
                    ...
                    <div class="input-form d-flex">
                        ...
                        <div class="form-floating mb-3 p-2 mx-2">
                            <input type="text" class="form-control" id="kode-kerusakan" name="kode_kerusakan"
                                readonly>
...
<div class="modal fade modal-fullscreen-md-down" id="kerusakanModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form id="tambah-kerusakan" action="{{ route('kerusakan.store') }}" method="post">
                    ...
                    <div class="input-form d-flex">
                        ...
                        <div class="form-floating mb-3 p-2 mx-2">
                            <input type="text" class="form-control" id="kode-kerusakan" name="kode_kerusakan"
                                placeholder="kode kerusakan" required>
                            <label for="kode-kerusakan">Kode Kerusakan</label>
                        </div>
                        <div class="form-floating mb-3 p-2 mx-2">
                            <input type="text" class="form-control" id="kerusakan" name="kerusakan"
...
<script>
    function updateInput(idkerusakan, kode, kerusakan, solusi){
