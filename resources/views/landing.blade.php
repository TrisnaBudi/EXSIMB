                ...
                <div class="accordion" id="faqAccordion">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                <h6>EXSIMB adalah sebuah situs yang membantu para rider untuk mendiagnosis kerusakan sepeda dengan
                                mengisi formulir pertanyaan. Kami juga menyediakan solusi sesuai formulir tersebut.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                            <div class="card-body">
                                <h6>EXSIMB ditujukan untuk para rider pemilik sepeda gunung, namun siapa saja dapat mengakses situs ini dan mengisi
                                formulir.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                            data-bs-parent="#faqAccordion">
                            <div class="card-body">
                                <h6>Hasil dari EXSIMB adalah sebuah kemungkinan, dan tidak bisa dianggap
                                sebagai diagnosis yang pasti. Kami sangat menyarankan agar rider tetap mendatangi teknisi apabila tidak mampu memperbaiki.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                            data-bs-parent="#faqAccordion">
                            <div class="card-body">
                                <h6> Setelah mengisi formulir, rider akan menerima rekomendasi solusi sesuai dengan kerusakan yang
                                terdeteksi.</h6>
                            </div>
                        </div>
                    </div>
